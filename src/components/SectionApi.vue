<template>
  <div>
        ...
        <div class="col-lg-6 col-xs-12"  v-for="(movies, index) of movies" :key="index">
    ...
    <div class="d-flex container-fluid justify-content-end pb-2 mt-n2">
      <a :href="'https://www.imdb.com/title/' + movies.imdbID" target="_blank" class="btn btn-outline-info">Info</a>
    </div>
  </div>
  </div>
  </div>
